...
parser.add_argument('--batch_size',type = int, default=10, help= 'Enter the batch size')
...
for epoch in range(args.epoch):
    ...
    if epoch % 15 == 0:
        torch.save(unet, 'checkpoints/'+ str(args.dataset) + '/NET_batch_'+ str(args.batch_size) + '_epoch_' + str(epoch) + '_' +str(args.lrate) + '_RGB_Flow_relu_BatchNorm'+ '.pt')
